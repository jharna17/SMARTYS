        ...
        <div id="homearticle">
            ...
            <?php 
                foreach ($allcat->result() as $row3){?>
                    <div>
                <?php
                    $location="home/category/".$row3->categoryname;
                ?>
                    <a href="<?php echo site_url($location);?>"> <?php echo $row3->categoryname; ?></a>
                    <h3>
                        <?php $location2="home/subcategory/".$subcatofacat->subcatname;?>
                        <a href="<?php echo site_url($location2);?>">    <?php echo $cat_art[$row3->categoryname]['subcat']; ?></a></h3>
