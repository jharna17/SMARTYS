...
<html>
    ...
    <body>
        ...
        <?php print_r($this->session->userdata()); echo "<BR>"; echo form_open_multipart('member/do_upload');
        ?>
        
        <fieldset>
            <legend>Personal Information</legend>
            <label>First Name: </label>
            <?php echo $this->session->userfname; ?>
                <br>
                <label>Last Name: </label>
                <?php echo $this->session->userlname; ?>
                <br>
                <label>Email ID: </label>
                <?php echo $this->session->useremailid; ?>
                <br>
        </fieldset>
        <fieldset>
