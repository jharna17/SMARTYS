...
<html>
    <head>
        ...
        <title><?php echo $subcategoryname; ?></title>
    ...
    <body>
        <div id="header">
            ...
            <div id="righttop">
                <a href="<?php echo site_url('admin/signout'); ?>">Signout</a>
            </div>
        ...
        <div id="topnav">
            ...
            <div id='sugart'>
                <a href="<?php echo site_url('admin/adminfunctions'); ?>">Suggest an article</a>
            </div>
        ...
        <?php print_r($this->session->userdata()); echo "<br>"; ?> 
            <?php for($i=0; $i<$subart->num_rows(); $i++){
                foreach($subart->result() as $row1){
            ?>
        
            <div id="featured-articles">
               
                <h2>
                    <?php echo $row1->authorid; ?>
                    <!-- Heading of the aricle -->
                </h2>
                
                    <pre><?php echo $row1->article; ?>
