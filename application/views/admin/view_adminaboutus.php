            ...
            <div id="myDropdown" class="dropdown-content">
                    ...
                    ?>
                            ...
                            foreach ($cat_sub[$row->categoryname]->result() as $subcatofacat){
                                $location1="admin/category/".$subcatofacat->subcatname;
                            ?>
        ...
        <div id="homearticle">
            ...
            <?php 
                foreach ($allcat->result() as $row3){?>
                    <div>
                <?php
                    $location="admin/category/".$row3->categoryname;
                ?>
                    <a href="<?php echo site_url($location);?>"> <?php echo $row3->categoryname; ?></a>
                    <?php $location2="admin/subcategory/".$cat_art[$row3->categoryname]['subcat']; ?>
